...
public interface UserMxgServlet {
	 ...
	 * @return 更新结果信息
	 */
	String updateUserHeadPortraitUrl (MultipartFile croppedImage, int userId, boolean banHeadPortrait, String userToken) throws BestException, IOException;
