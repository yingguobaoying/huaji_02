...
//import com.huaji.galgamebyhuaji.model.BuyResourcesUser;
...
//			MyLogUtil.info(UserBehaviorServiceImpl.class, "id为{%d}的用户购买了外部资源链接".formatted(userId));
//			//返回令牌
...
//					Constant.RESOURCE_EXPIRATION_TIME * 60 * 60 * 1000L
//			);
//			MyLogUtil.info(UserBehaviorServiceImpl.class, "id为{%d}的用户购买了本地资源下载".formatted(userId));
//			//返回令牌
//			return ReturnResult.isTrue(
//					"您购买了该资源的本地下载权限。",
//					userToken.getToken()
