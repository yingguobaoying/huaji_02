...
public interface UserBehaviorService {
	 ...
	 * @return 生成的令牌
	 */
	ReturnResult<String> buyOutsideDown (Integer userId, Integer rId,String ip) throws SessionExceptions;
	
	ReturnResult<String> buyAll (Integer userId, Integer rId, String ip) throws SessionExceptions;
