...
//		String jwt = request.getHeader(SystemConstant.JWT_TOKEN_NAME);
//		if ( MyStringUtil.isNull(jwt) ) {
//			jwt = (String) request.getAttribute(SystemConstant.JWT_TOKEN_NAME);
//		}
//		if ( MyStringUtil.isNull(jwt) ) {
//			HttpSession session = request.getSession(false);
//			if ( session != null )
//				jwt = (String) session.getAttribute(SystemConstant.JWT_TOKEN_NAME);
//		}
//		if ( MyStringUtil.isNull(jwt) ) {
//			Cookie[] cookies = request.getCookies();
//			if ( cookies != null ) {
//				for ( Cookie c : cookies ) {
//					if ( SystemConstant.JWT_TOKEN_NAME.equals(c.getName()) ) {
...
//		}
//		return jwt;
		return getToken(request, Constant.JWT_TOKEN_NAME);
	}
